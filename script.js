document.getElementById('membership-form').addEventListener('submit', async function (e) {
  ...
  const formData = {
      ...
      emergencyRelationship: document.getElementById('emergencyname').value, // Correct duplicate IDs
  ...
  try {
      const response = await fetch('https://your-backend-service.onrender.com/submit-form', { // Replace with your backend URL
          method: 'POST',
